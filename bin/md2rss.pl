...
Ein kleines Programm das aus einer Markdown Datei einen RSS Feed
erstellt.
Als Vorlage wird aber die C<pandoc> Variante von markdown verwendet.
...
Als rss.md0x kann man sich an folgender Vorlage orientieren.
